      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Comprehensive reference for all props, methods, and configuration
            options.
          </p>
        </div>
              ...
              <Card>
                ...
                <CardContent>
                  <CodeBlock
                    code={propsInterface}
                    language="tsx"
                    title="TagsInputFieldProps Interface"
                  />
            ...
            <TabsContent value="examples" className="mt-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Common implementation patterns and configurations.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <CodeBlock
            ...
            <TabsContent value="forms" className="mt-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    How to integrate with React Hook Form and validation
                    libraries.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <CodeBlock
                    code={formIntegration}
                    language="tsx"
                  ...
                  <div className="mt-6 p-4 bg-primary-50 dark:bg-primary-950/20 rounded-lg border border-primary-200 dark:border-primary-800">
                    ...
                    <p className="text-sm text-primary-700 dark:text-primary-300">
                      The component must be wrapped in a FormProvider from React
                      Hook Form. This enables form validation, error handling,
            ...
            <TabsContent value="keyboard" className="mt-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Built-in keyboard interactions for better user experience.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <CodeBlock
                    code={keyboardShortcuts}
                    language="text"
